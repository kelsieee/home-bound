      ...
      <div class="container-fluid">
        <ul class="list-unstyled navbar my-1 mx-3 my-lg-0 d-flex">
          <li class="d-flex">
            ...
            <input class="form-control me-2 bg-secondary bg-opacity-25" style="border-radius: 30px;"type="search" placeholder="Location" aria-label="Location">
          </li>
          <li class="d-flex">
            ...
            <input class="form-control me-2 bg-secondary w-100 bg-opacity-25" style="border-radius: 30px;" type="search" placeholder="Search" aria-label="Search">
          </li>
          <li>
            <form>
        ...
        <ul class="navbar-nav  mb-2 mb-lg-2 container-fluid">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="black" class="bi bi-sliders2" viewBox="0 0 16 16">
                ...
                <li><h4>Roomies</h4></li>
                <li><a class="dropdown-item" href="#"><h6>Cleanliness</h6></a></li>
                ...
                <li><a class="dropdown-item" href="#"><h6>Overnight Stay</h6></a></li>
                <li>
                ...
                <li><a class="dropdown-item" href="#"><h6>Price per month</h6></a></li>
                ...
                <li><a class="dropdown-item" href="#"><h6>Number of Rooms</h6></a></li>
